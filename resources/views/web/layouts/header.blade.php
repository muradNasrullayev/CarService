    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ route('home') }}" class="nav-item nav-link @if(in_array(url()->current(), [route('home'), env('APP_URL')])) active @endif">Home</a>
                <a href="{{ route('about') }}" class="nav-item nav-link @if(url()->current() === route('about')) active @endif">About</a>
                <a href="{{ route('service') }}" class="nav-item nav-link @if(url()->current() === route('service')) active @endif">Services</a>
