                            ...
                            <a class="dropdown-item d-flex align-items-center"
                               href="{{route('admin.contact.edit',$contact->id)}}">
                                <div class="font-weight-bold">
                                    <div @if($contact->read_unread==0)  class="text-truncate" @endif>
                                        {{$contact->message}}
                                    </div>
                                    <p>
                                    ...
                                    <div class="small text-gray-500">{{$contact->name.' '.$contact->surname}}</div>
                                </div>
                            </a>
                        @endforeach

                        <a class="dropdown-item text-center small text-gray-500"
                           href="{{route('admin.contact.index')}}">Read More Messages</a>
                    </div>
                </li>
